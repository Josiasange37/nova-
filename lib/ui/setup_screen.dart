        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Step 1: Enable Wireless Debugging in Developer Options, then tap\n"Pair with pairing code" and enter the details below.',
                style: TextStyle(color: Color(0xFF8B949E), fontSize: 12)),
              const SizedBox(height: 12),
              _darkField(_pairPortCtrl, 'Pairing Port (e.g. 34567)', keyboard: TextInputType.number),
              const SizedBox(height: 8),
              _darkField(_pairCodeCtrl, 'Pairing Code (6 digits)', keyboard: TextInputType.number),
              const SizedBox(height: 8),
              _actionButton('Pair Device', _pair),

              const SizedBox(height: 20),
              const Text('Step 2: After pairing, enter the port from the Wireless Debugging main screen.',
                style: TextStyle(color: Color(0xFF8B949E), fontSize: 12)),
              const SizedBox(height: 12),
              _darkField(_connectPortCtrl, 'ADB Port (e.g. 45678)', keyboard: TextInputType.number),
              const SizedBox(height: 8),
